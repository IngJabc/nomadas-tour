...
interface TripPostponedEmailProps {
  agencyName: string;
  origin: string;
  destination: string;
...
export function TripPostponedEmail({
  agencyName,
  origin,
  destination,
  oldDepartureTime,
      ...
      <body style={bodyStyle}>
        <div style={containerStyle}>
          <div style={cardStyle}>
            ...
            <h1 style={titleStyle}>Viaje reprogramado</h1>
            ...
            <p style={textStyle}>
              Un viaje ha sido reprogramado. A continuación los detalles:
            </p>
            ...
            <div style={infoBoxStyle}>
              <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                <tbody>
                  <tr>
                    <td style={infoLabelStyle}>Ruta</td>
                    <td style={infoValueStyle}>{origin} → {destination}</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div style={scheduleBoxStyle}>
              <div style={scheduleRowStyle}>
                <span style={scheduleLabelOldStyle}>Horario anterior</span>
                <span style={scheduleValueOldStyle}>{oldDepartureTime}</span>
              </div>
              <div style={scheduleDividerStyle} />
              <div style={scheduleRowStyle}>
                <span style={scheduleLabelNewStyle}>Nuevo horario</span>
                <span style={scheduleValueNewStyle}>{newDepartureTime}</span>
              </div>
            </div>

            <div style={buttonContainerStyle}>
              <a href={tripLink} style={buttonStyle}>
                Ver viaje
              </a>
            </div>
...
const scheduleLabelOldStyle: React.CSSProperties = {
  fontSize: '12px',
  fontWeight: 600,
  color: '#92400e',
  textTransform: 'uppercase' as const,
...
const scheduleValueOldStyle: React.CSSProperties = {
  fontSize: '14px',
  fontWeight: 600,
  color: '#92400e',
...
const scheduleLabelNewStyle: React.CSSProperties = {
  fontSize: '12px',
  fontWeight: 600,
  color: '#065f46',
  textTransform: 'uppercase' as const,
...
const scheduleValueNewStyle: React.CSSProperties = {
  fontSize: '14px',
  fontWeight: 700,
  color: '#065f46',
};
