...
export function RegistrationCompleteEmail({ agencyName, email, loginUrl }: RegistrationCompleteEmailProps) {
  return (
    <html>
      <head>
        <meta charSet="utf-8" />
      ...
      <body style={bodyStyle}>
        <div style={containerStyle}>
          <div style={cardStyle}>
            ...
            <h1 style={titleStyle}>Registro completado</h1>
            ...
            <p style={textStyle}>
              Tu cuenta para <strong>{agencyName}</strong> ha sido creada correctamente en Nómadas Tour.
            </p>

            <div style={infoBoxStyle}>
              <p style={infoLabelStyle}>Correo electrónico</p>
              <p style={infoValueStyle}>{email}</p>
            </div>

            <p style={textStyle}>
              Ya puedes acceder al panel de agencia utilizando tu correo y contraseña.
            </p>
