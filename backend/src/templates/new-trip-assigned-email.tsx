...
interface NewTripAssignedEmailProps {
  agencyName: string;
  origin: string;
  destination: string;
...
export function NewTripAssignedEmail({
  agencyName,
  origin,
  destination,
  departureTime,
  ...
  capacity,
  tripLink,
}: NewTripAssignedEmailProps) {
  const vehicleLabel = vehicleType === 'bus' ? 'Autobús' : 'KIA';
      ...
      <body style={bodyStyle}>
        <div style={containerStyle}>
          <div style={cardStyle}>
            ...
            <h1 style={titleStyle}>Nuevo viaje asignado</h1>
            ...
            <p style={textStyle}>
              Se te ha asignado un nuevo viaje. A continuación los detalles:
            </p>
              ...
              <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td style={infoValueStyle}>{departureTime}</td>
                  </tr>
                  <tr>
                    <td style={infoLabelStyle}>Vehículo</td>
                    <td style={infoValueStyle}>{vehicleLabel} · {capacity} puestos</td>
                  </tr>
                </tbody>
              </table>
            </div>
