            ...
            <Card>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                <div className="text-center p-3 rounded-xl bg-[rgba(0,212,255,0.08)]">
                  <p className="font-[family-name:var(--font-body)] font-normal text-[10px] text-[var(--color-brand-muted)] uppercase tracking-wide mb-1">
                    Disponibles
                  </p>
                  <p
                    className={`font-[family-name:var(--font-heading)] font-bold text-[24px] ${
                      stats.available > 0
                  ...
                  <table className="w-full text-left">
                    <thead>
                      <tr className="border-b border-[rgba(0,0,0,0.06)]">
                        <th className="pb-2 font-[family-name:var(--font-body)] font-semibold text-[11px] text-[var(--color-brand-muted)] uppercase tracking-wide">
                          Nombre
                        </th>
                        <th className="pb-2 font-[family-name:var(--font-body)] font-semibold text-[11px] text-[var(--color-brand-muted)] uppercase tracking-wide">
                          Asiento
                ...
                <div className="flex flex-wrap items-center gap-4 mt-4 pt-4 border-t border-[rgba(0,0,0,0.06)]">
                  <div className="flex items-center gap-1.5">
                    <div
                      ...
                      style={{
                        background:
                          "linear-gradient(180deg, #00D4FF 0%, #00D4FF 52%, #00b8d9 52%, #00b8d9 100%)",
                      }}
                    />
                  ...
                  <div className="flex items-center gap-1.5">
                    <div
                      ...
                      style={{
                        background:
                          "linear-gradient(180deg, #374151 0%, #374151 52%, #1f2937 52%, #1f2937 100%)",
                      }}
                    />
                    <span className="font-[family-name:var(--font-body)] text-[10px] text-[var(--color-brand-muted)]">
                      Reservado
                  ...
                  <div className="flex items-center gap-1.5">
                    <div
                      ...
                      style={{
                        background:
                          "linear-gradient(180deg, #10b981 0%, #10b981 52%, #059669 52%, #059669 100%)",
                      }}
                    />
                    <span className="font-[family-name:var(--font-body)] text-[10px] text-[var(--color-brand-muted)]">
                      Abordado
