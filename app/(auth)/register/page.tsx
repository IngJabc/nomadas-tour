      ...
      <div className="flex-1 flex pt-16">
        ...
        <div className="w-full lg:w-1/2 flex items-start lg:items-center justify-center px-5 sm:px-8 lg:px-12 py-8 sm:py-12 bg-brand-surface">
          <div className="w-full max-w-sm text-center">
            ...
            <p className="font-['Poppins',sans-serif] text-sm text-brand-muted mb-6">
              {error}
            </p>
            <Link
              href="/"
              className="inline-flex items-center gap-1 px-5 py-2.5 rounded-xl bg-brand-cyan text-white font-['Poppins',sans-serif] font-semibold text-sm no-underline hover:bg-brand-blue transition-colors"
            >
              Volver al inicio
            </Link>
          </div>
      ...
      <div className="w-full lg:w-1/2 flex items-start lg:items-center justify-center px-5 sm:px-8 lg:px-12 py-8 sm:py-12 bg-brand-surface">
        ...
        >
          ...
          <p className="mt-2 mb-6 sm:mb-8 font-['Poppins',sans-serif] font-normal text-sm text-brand-muted">
            Completa la contraseña para activar tu agencia
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                value={agencyName}
                disabled
                className="w-full border-[1.5px] border-gray-200 rounded-xl py-3 px-4 font-['Poppins',sans-serif] font-normal text-sm text-brand-navy bg-slate-50 outline-none cursor-not-allowed"
              />
            </div>
            ...
            <button
              type="submit"
              disabled={loading || invValid !== true}
              ...
              style={{
                background: loading
                  ...
                  : "var(--color-brand-cyan)",
                cursor:
                  loading || invValid !== true ? "not-allowed" : "pointer",
                opacity: loading || invValid !== true ? 0.5 : 1,
              }}
              onMouseEnter={(e) => {
                if (!loading && invValid === true)
