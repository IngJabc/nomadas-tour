    ...
    <div className="flex-1 flex pt-16">
      ...
      <div className="w-full lg:w-1/2 flex items-start lg:items-center justify-center px-5 sm:px-8 lg:px-12 py-8 sm:py-12 bg-brand-surface">
        ...
        >
          ...
          <h1 className="font-['Montserrat',sans-serif] font-extrabold text-[24px] sm:text-[28px] text-brand-navy text-center">
          ...
          {sent ? (
            <div className="text-center py-8">
              ...
              <h2 className="font-['Montserrat',sans-serif] font-bold text-lg text-brand-navy mb-2">
                Correo enviado
              </h2>
