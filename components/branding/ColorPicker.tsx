    ...
    <div className="space-y-2">
      ...
      <div className="flex items-center gap-3">
        ...
        <input
          ...
          className="w-12 h-12 rounded-xl border-[1.5px] border-[#e5e7eb] bg-white p-1 cursor-pointer disabled:opacity-40 disabled:cursor-not-allowed"
        />
        <input
          id={`${id}-hex`}
          type="text"
          ...
          className={cn(
            'w-full border-[1.5px] rounded-xl px-4 py-3 bg-white outline-none transition-all duration-200',
