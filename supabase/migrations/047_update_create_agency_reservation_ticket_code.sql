-- ============================================================
-- 047_update_create_agency_reservation_ticket_code.sql
-- AUD-020.11 — Persist ticket_code on new agency reservations.
--
-- Rules:
--   - CREATE OR REPLACE only; same signature as 014
--   - Derive ticket_code from reservation UUID (never from qr_code)
--   - Keep qr_code generation unchanged
--   - Reaffirm EXECUTE grants (service_role only, per 037)
-- ============================================================
...
COMMENT ON FUNCTION public.create_agency_reservation(
  ...
  'Atomic agency reservation create. Persists ticket_code from reservation UUID (AUD-020.11). SECURITY DEFINER; EXECUTE service_role only.';

-- Reaffirm grants after REPLACE (same posture as 037)
